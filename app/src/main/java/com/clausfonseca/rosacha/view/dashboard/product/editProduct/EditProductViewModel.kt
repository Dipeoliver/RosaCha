...
class EditProductViewModel @Inject constructor(
    ...
    fun updateProduct(dbProduct: String, productModel: ProductModel) {
        viewModelScope.launch {
            productUseCases.updateProduct.invoke(dbProduct, productModel ).collect {
                when (it) {
                    is Resource.Error -> {
                    ...
                    is Resource.Success -> {
                        ...
                        model.screenState.value = CommonModelState.CommonState.Loading(false)
                        model.screenState.value = CommonModelState.CommonState.SuccessUpdate
                    }
                }
            }
        }
